...
let result1 = buildName('Bobe'); //Bob undefinded
// console.log(result1);
...
let result4 = buildName('Bobe'); //Bob undefinded
// console.log(result4);
...
let result5 = buildName2('Bobe'); //Bob sans undefinded
// console.log(result5);
...
let result6 = buildName3('Bobe'); //Bob Smith
// console.log(result6);

//ici le 2em valeur est remlacé (écrasé)  < Smith >
let result7 = buildName3('Bobe', 'Artur'); //Bob Artur
// console.log(result7);

//on peut également dire que 2em valeur est undefined, puis il sera remplacer par <Smith>
let result8 = buildName3('Bobe', undefined); //Bob Smith
console.log(result8);
